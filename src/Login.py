...
def Loginform():
    ...
    Label(login_screen,width="300", text="Please enter details below", bg="#87CEEB",fg="white").pack()
    #Username Label
    ...
    #Login button
    Button(login_screen, text="Login", width=10, height=1, bg="#87CEEB",command=login).place(x=105,y=130)
